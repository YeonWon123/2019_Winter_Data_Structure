...
(given by twice the length of S(k - 1) plus the length of the middle section, k + 3).
Afterwards, we can figure out the nth chracter in S(k) by checking if n lies in the left copy of S(k - 1) 
(in which case we can proceed by recursion),
in the middle section, or in the right copy of S(k - 1) (in which case we can again proceed by recursion).
*/
